...
public class ShipinguankanjiluView extends ShipinguankanjiluEntity implements Serializable {
	...
	public ShipinguankanjiluView() {

	}

	public ShipinguankanjiluView(ShipinguankanjiluEntity shipinguankanjiluEntity) {
		try {
			BeanUtils.copyProperties(this, shipinguankanjiluEntity);
